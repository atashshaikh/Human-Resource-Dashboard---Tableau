...
• Data Modeling & Joins –  Combined employee, department, and salary data<br>
• Calculated Fields (144 total) –  KPIs like Total Hired, Total Terminated, % Terminated, and HQ vs Branch logic<br>
...
Employee ID, Department, Job Role, Gender, Education, and State<br>
...
Organizations often face challenges consolidating HR data to evaluate workforce trends, performance, and retention. Manual analysis across spreadsheets leads to inefficiencies and poor visibility into critical HR KPIs.
...
• Analyzes workforce demographics (gender, age, education)

• Examines pay distribution and salary equity

• Enables data-driven workforce planning

📊 Key Visuals

Overview: KPIs for Active, Hired, and Terminated Employees

Departments: Department-wise distribution of employees, hires, and exits
